...
public class DLoginActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        buttonDLogin = findViewById(R.id.btn_dlogin);
        ...
        buttonDLogin.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                ...
                if (TextUtils.isEmpty(email)){
                    Toast.makeText(DLoginActivity.this, "Enter E-mail", Toast.LENGTH_SHORT).show();
                    return;
                }

                if (TextUtils.isEmpty(password)){
                    Toast.makeText(DLoginActivity.this, "Enter password", Toast.LENGTH_SHORT).show();
                    return;
                }
                        ...
                        .addOnCompleteListener(new OnCompleteListener<AuthResult>() {
                            ...
                            public void onComplete(@NonNull Task<AuthResult> task) {
                                ...
                                if (task.isSuccessful()) {
                                    ...
                                    Toast.makeText(DLoginActivity.this, "Authentication failed.",
